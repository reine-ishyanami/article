import{_ as e,r as t,o as i,c as o,a as n,b as s,d as p,e as l}from"./app-13938b94.js";const c="/article/assets/gradleMultiMudole_01-f2890e18.png",r={},u=n("h1",{id:"gradle-多模块项目构建",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#gradle-多模块项目构建","aria-hidden":"true"},"#"),s(" Gradle 多模块项目构建")],-1),d={href:"https://github.com/reine-ishyanami/article/tree/master/code/gradle-multi-module",target:"_blank",rel:"noopener noreferrer"},v=l('<ol><li>演示项目的目录结构</li></ol><p><img src="'+c+`" alt="project structure"></p><ol start="2"><li><p>父项目<code>gradle.properties</code>用于定义一些用在<code>build.gradle</code>中的属性</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">group</span><span class="token punctuation">=</span><span class="token value attr-value">com.reine</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol>`,3);function k(m,g){const a=t("ExternalLinkIcon");return i(),o("div",null,[u,n("p",null,[n("a",d,[s("演示项目具体代码"),p(a)])]),v])}const y=e(r,[["render",k],["__file","gradleMultiModule.html.vue"]]);export{y as default};

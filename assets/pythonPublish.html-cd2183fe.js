import{_ as t,r as p,o as i,c as l,a as n,b as s,d as o,e as a}from"./app-d3715aa7.js";const c={},u=n("h1",{id:"python应用打包发布",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python应用打包发布","aria-hidden":"true"},"#"),s(" Python应用打包发布")],-1),r=a(`<li><p>注册Pypi账号</p></li><li><p>安装build（建议在虚拟环境中安装）</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>sourc.venv/bin/activate
...
<span class="token key property">requires-python</span> <span class="token punctuation">=</span> <span class="token string">&quot;&gt;=3.10, &lt;4.0&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>`,3);function v(m,b){const e=p("ExternalLinkIcon");return i(),l("div",null,[u,n("ol",null,[r,n("li",null,[n("p",null,[s("选中开源协议，将协议内容填到LICENSE文件中"),n("a",d,[s("choosealicense"),o(e)])])]),k])])}const g=t(c,[["render",v],["__file","pythonPublish.html.vue"]]);export{g as default};

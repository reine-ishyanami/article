import{_ as t,r as p,o as i,c as l,a as n,b as s,d as o,e as a}from"./app-13938b94.js";const c={},u=n("h1",{id:"python应用打包发布",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python应用打包发布","aria-hidden":"true"},"#"),s(" Python应用打包发布")],-1),r=a(`<li><p>注册Pypi账号</p></li><li><p>安装build（建议在虚拟环境中安装）</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>sourc.venv/bin/activate
